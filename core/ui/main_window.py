...
class ModernScraperGUI(QMainWindow):
    ...
    def create_dashboard_tab(self):
        ...
        self.dashboard_activity_log.setMaximumHeight(150)
    ...
    def create_google_maps_tab(self):
        ...
        layout = QVBoxLayout(maps_widget)
        layout.setContentsMargins(20, 20, 20, 20)
    ...
    def create_control_buttons(self, layout):
        ...
        self.start_btn = QPushButton("Start Scraping Process")
        ...
        self.save_btn = QPushButton("Export All Results to CSV")
        self.save_btn.setObjectName("saveBtn")
        self.save_btn.clicked.connect(self.save_all_csv)
        button_layout.addWidget(self.save_btn)
        
        self.save_unique_btn = QPushButton("Export Unique Results to CSV")
        self.save_unique_btn.setObjectName("saveUniqueBtn")
        self.save_unique_btn.clicked.connect(self.save_unique_csv)
        button_layout.addWidget(self.save_unique_btn)
        
        self.clear_btn = QPushButton("Clear All Results")
    ...
    def create_results_table(self, layout):
        ...
        header.resizeSection(0, 150)  # Keyword
        header.resizeSection(1, 200)  # Name
        header.resizeSection(2, 200)  # Website
        header.resizeSection(3, 120)  # Phone
        header.resizeSection(4, 250)  # Address
        header.resizeSection(5, 80)   # Rating
